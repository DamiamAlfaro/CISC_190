...
public class Checkingaccount extends Bankaccount {
    ...
    public void withdrawAmount(double amountToWithdraw) throws TooManyWithdrawalsException, InvalidAmountException{
        double currentBalance = getBalance();
        
        // In CheckinAccount, throw an InvalidAmountException  if a programmer tries to withdraw more than allowed.
        if (amountToWithdraw > getBalance()) {
            throw new InvalidAmountException(amountToWithdraw);
        }
